        ...
        <main>
          ...
          <FadeInSection>
            <div id="about" className="py-4">
              ...
              <p>
                ...
                only delivered high-quality dance tutorials but also
                incorporated interactive features like augmented reality and
                real-time feedback, ensuring users could actively measure their
                progress.
              </p>
              <p>
              ...
              <p>
                ...
                Create personas, user stories, users journey map, problem and
                goal statement, competitive audit and report, paper and digital
            ...
            <FadeInSection>
              ...
              <div className="row">
                ...
                <div className="col shadow p-3 m-3 bg-white rounded">
                  ...
                  <p>
                    Without real-time correction, users might continue
                    practicing moves incorrectly, leading to frustration or
                    potential injury
                  </p>
                </div>
                <div className="col shadow p-3 m-3 bg-white rounded">
                  ...
                  <p>
                    With an extensive catalog of dance styles and tutorials,
                    some users might feel overwhelmed, unsure of where to start
                    or how to progress
                  </p>
                </div>
              </div>
                ...
                <div className="row">
                  <div className="col shadow p-3 m-3 bg-white rounded">
                    ...
                    <p>
                      ...
                      relief, I want to find beginner-level dance tutorials
                      easily so that I can start learning without feeling
                      overwhelmed.
                    </p>
                  </div>
                  <div className="col shadow p-3 m-3 bg-white rounded">
                    <h6>Alex Kim</h6>
                    <p>
                      As an college student preparing for a cultural fest, I
                      want tutorials that are categorized according to skill
                      level so that I can find content that matches my current
                      abilities and helps me progress at my own pace.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <FadeInSection>
              <div className="my-3">
                ...
                <p>
                  ...
                  use dancing as a form of exercise and stress relief to those
          ...
          <div id="usability" className="py-4">
            <FadeInSection>
              ...
              <div className="my-3 row">
                <p>
                  I conducted usability study. Tests were conducted on
                  wireframes.
                </p>
                ...
                <div className="col shadow p-3 m-3 bg-white rounded ">
                  <h6>Class detail</h6>
                  <p>
                    <strong>Problem:</strong> When the user is on the class
                    detail page, there is no option to go back
                  </p>
                  <p>
                    {" "}
                ...
                <div className="col shadow p-3 m-3 bg-white rounded ">
                  ...
                  <p>
                    <strong>Solution:</strong> Added the option to select from
                    the navigation, making it quicker for users to find what
                    they need. However, the possibility to choose from the
                    separate page still exists
                  </p>
                </div>
              </div>
            </FadeInSection>
          ...
          <div id="conclusion">
            <FadeInSection>
              ...
              <p>
                {" "}
                <strong> What I learned</strong> I learned about the UX/UI
