          ...
          <div id="about" className="py-4">
            ...
            >
              ...
              <p>
                ...
                illiteracy and the overwhelming feeling many individuals face
                when trying to manage their finances. By identifying a societal
                need for accessible and user-friendly financial education seeks
                to demystify budgeting and promote financial well-being for its
                users.
              </p>
            </FadeInSection>
          </div>
          ...
          <div id="research" className="py-4">
              ...
              <div className="row">
                ...
                <div className="col shadow p-3 m-3 bg-white rounded">
                  ...
                  <p>
                    ...
                    multiple devices, and lack of such support can be a
                    deterrent
                  </p>
                </div>
                <div className="col shadow p-3 m-3 bg-white rounded">
                ...
                <div className="row">
                  <div className="col shadow p-3 m-3 bg-white rounded">
                    ...
                    <p>
                      ...
                      access a comprehensive budgeting tool on a larger screen,
                      So that I can have a clear overview of my income,
            ...
            <FadeInSection>
              <div className="my-3">
                ...
                <p>
                  I conduct user research through personas, user empathy maps,
                  and problem statement and I conduct a competitive audit to
                  assess the strengths and weaknesses of competitors in the
                  budgeting platform market and identify opportunities for
                  differentiation
                </p>
              </div>
            </FadeInSection>
            ...
            <FadeInSection>
              ...
              <div className="my-3 row">
                ...
                <div className="col shadow p-3 m-3 bg-white rounded col">
                  ...
                  <p>
                    Users missed the "delete" button to remove a savings
                    category they added but no longer wanted
                  </p>
                </div>
                <div className="col shadow p-3 m-3 bg-white rounded col">
                  ...
                  <p>
                    ...
                    categories in the budget section. They miss the ability to
                    add a new budget for spending in a category and to edit or
                    delete it.
                  </p>
                </div>
              </div>
