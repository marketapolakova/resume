  ...
  return (
    <div>
      <div className="container mx-5 my-5">
        <h1>Website for finding and viewing dance classes</h1>
        ...
        <p>
          <strong>My role: </strong> Ux designer designing a responsive website
          for finding and viewing dance classes from start to end
        </p>
        <p>
          <strong>The goal:</strong> Create a responsive website that not only
          delivered high-quality dance tutorials but also incorporated
          interactive features like augmented reality and real-time feedback,
          ensuring users could actively measure their progress.
        </p>
        <p>
          <strong>Tagert audience:</strong> Everyone who wants to learn dancing
          or just love dance (from amateur to professional)
        </p>
        <p>
        ...
        <div className="row">
          <div class="col shadow p-3 m-3 bg-white rounded">
            ...
            <p>
              Users might struggle to find tutorials tailored to their specific
              skill level or the style they're interested in
            </p>
          </div>
          <div class="col shadow p-3 m-3 bg-white rounded">
          ...
          <div class="col shadow p-3 m-3 bg-white rounded">
            ...
            <p>
              ...
              users might feel overwhelmed, unsure of where to start or how to
              progress
            </p>
          </div>
        </div>
        ...
        <div className="mb-3">
          ...
          <div className="row">
            <div class="col shadow p-3 m-3 bg-white rounded">
              <h6>Maria Gomez</h6>
              <p>
                As a physical therapist who enjoys dancing for stress relief, I
                want to find beginner-level dance tutorials easily so that I can
            ...
            <div class="col shadow p-3 m-3 bg-white rounded">
              ...
              <p>
                ...
                tutorials that are categorized according to skill level so that
                I can find content that matches my current abilities and helps
                me progress at my own pace.
              </p>
            </div>
          </div>
        </div>
        <div className="mb-3">
          ...
          <p>
            I conduct user research through personas, create user empathy maps,
            and describe the problem statement. I also conduct a competitive
            audit. The research indicates that the application is suitable for
            everyone. From individuals who simply want to use dancing as a form
            of exercise and stress relief to those who aspire to learn dancing
            professionally.
          </p>
        </div>
        ...
        <div className="mb-3 row">
          ...
          <div class="col shadow p-3 m-3 bg-white rounded ">
            ...
            <p>
              {" "}
              <strong>Problem:</strong> Some users were confused about how to
          ...
          <div class="col shadow p-3 m-3 bg-white rounded ">
            ...
            <p>
              ...
              navigation, users were taken to a separate page, which some found
              distracting
            </p>
            <p>
              <strong>Solution:</strong> Added the option to select from the
              navigation, making it quicker for users to find what they need.
              However, the possibility to choose from the separate page still
              exists
            </p>
          </div>
        </div>
