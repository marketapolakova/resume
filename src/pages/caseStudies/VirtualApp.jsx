  ...
  return (
    <div>
      <div className="container mx-5 my-5">
        <NavbarTop />
        <h1> Virtual tour app for art gallery</h1>
        ...
        <div id="about">
          ...
          <p>
            ...
            accurate representation and preservation of artworks and adhering to
        ...
        <div id="research">
          ...
          <div className="mb-3">
            ...
            <p>
              Competitive audit goal: The goal is to comprehend the competitive
              landscape for virtual art gallery tours, pinpoint the strengths
              and weaknesses of key competitors, and identify potential gaps and
              opportunities to enhance our virtual tour app.
            </p>
            <span className="d-flex align-items-center justify-content-center">
              <img
                style={{ width: "100%" }}
